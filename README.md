...
This means you can play as any NPC which walks around in the overworld. This also means sprites in this format inside the asset folder will appear in the mod spritelist.
